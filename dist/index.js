...
var import_data_uri_to_buffer = __toModule(require("data-uri-to-buffer"));

// node_modules/node-fetch/src/body.js
var import_stream = __toModule(require("stream"));
var import_util = __toModule(require("util"));
var import_fetch_blob = import("fetch-blob");
...
var Body = class {
  ...
  async blob() {
    ...
    return new (await import_fetch_blob).default([buf], {
      type: ct
    });
  }
  async json() {
